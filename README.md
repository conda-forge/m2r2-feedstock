...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/m2r2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10439&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/m2r2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `m2r2` can be installed with:

```
conda install m2r2
```

It is possible to list all of the versions of `m2r2` available on your platform with:
